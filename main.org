...
ability of Perovskite property models to extrapolate with respect to
alloying scheme. It also provides an opportunity to investigate the
statistical impact of constituent compounds on Perovskite property
performance.
...
*** learning curves
- scores vs training set size for RFR and GPR band gap
*** 
...
The scoring metrics we choose vary by model architecture. See [[HPO
Summary Tables]].
