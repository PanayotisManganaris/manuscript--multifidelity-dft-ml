...
compliant[[cite:&buitinck-2013-api]] interface[fn:5] extensively modified
from the original Matgenix[fn:6] code. Additionally, the algorithm is
informed of [[gls:ft][features]] units so that it is restricted to meaningful
linear combinations. SIS [[gls:ft][features]] complexity is restricted to a
...
[[file:./RFR/.ob-jupyter/704d3204752bc52a936aeb9d96e45380512c8c3d.png]]
...
#+attr_latex: :width 450pt
[[file:./GPR/.ob-jupyter/df8f4cdfbd4884fe978d0b0dc85e13e95137248c.png]]
...
** DONE SISSO Model and Incidental Engineered Features
:STATUSLOG:
