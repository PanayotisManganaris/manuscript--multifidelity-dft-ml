...
\label{sec:org0166596}
\subsection*{Multi-Fidelity Learning}
\label{sec:org0d36873}
...
\label{sec:orgc822f97}
\subsubsection*{Perovskite Band Gaps}
\label{sec:orgcc62905}
...
expected to aid in \hyperref[sec:orgbc42280]{inverse design} and in \hyperref[sec:org3d0fe08]{Feature Engineering}.
...
The SIS operator implemented by the \ACRshort{sisso} code\cite{ouyang-2018-sisso}
...
Computing \ACRshort{gpr} in conjunction with SIS features, we can create much
