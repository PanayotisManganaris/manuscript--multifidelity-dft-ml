...
%class options [society, journal, layout (preprint, reprint, twocolumn)]

\usepackage[export]{adjustbox} %% expanded control over image, minipages, etc
\usepackage{abstract} %% easy single col abstract in double col manuscript
...
\usepackage[in]{fullpage} %% set of preset page margin configurations
...
%\rnewcommand{\section}[1]{%
%\section[#1]{\centering\normalfont\scshape #1}}
%\renewcommand{\subsection}[1]{%
%\subsection[#1]{\bfseries\normalfont\scshape #1}}
%\renewcommand{\subsubsection}[1]{%
%\subsubsection[#1]{\bfseries\normalfont\scshape #1}}
...
\altaffiliation{School of Materials Engineering, Purdue University, West Lafayette, Indiana 47907, USA}
\email{amannodi@purdue.edu}
\affiliation{Mannodi Research Group}
...
\label{sec:org1acc6d6}
\ldots{}\\

\section*{ACKNOWLEDGMENTS}
\label{sec:orgc816b25}
