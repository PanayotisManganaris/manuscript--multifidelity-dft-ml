...
\label{sec:orgc8ba3cb}
\subsection*{Multi-Fidelity Learning}
\label{sec:org2df709c}
...
\label{sec:org0dd718d}
\subsubsection*{Perovskite Band Gaps}
\label{sec:org1522c6b}
...
expected to aid in \hyperref[sec:org3a8869d]{inverse design} and in \hyperref[sec:org5c607b7]{Feature Engineering}.
...
\citet{yang-2022-high-throug} and in \hyperref[sec:org5cc1c13]{DFT Details}.
...
\hyperref[sec:org2f0b3f7]{Methods}.
...
organic-inorganic samples. See figure \ref{fig:lot_mix_org}. See \hyperref[sec:org2f0b3f7]{Methods}
...
perovskite property prediction. See \hyperref[sec:org3f0f813]{Results and Discussion}.
...
adapter\footnote{\url{https://github.com/PanayotisManganaris/yogi}\label{org8d876c6}}.
...
simple entropy minimization algorithm\textsuperscript{\ref{org8d876c6}}.
...
\section*{Methods}
\label{sec:org2f0b3f7}
\subsection*{DFT Details}
\label{sec:org5cc1c13}
...
constituents, we provide a Python tool\footnote{\url{https://github.com/PanayotisManganaris/cmcl}\label{org24a3436}} which robustly coverts
...
\label{sec:org330d610}
\section*{Future Work}
\label{sec:org3a8869d}
\subsection*{Data Science and Materials Engineering}
\label{sec:orgb6d6820}
