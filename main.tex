...
\label{sec:org84a83b4}
\subsection*{Multi-Fidelity Learning}
\label{sec:orgf239e44}
...
\label{sec:orgfb7381f}
\subsubsection*{Perovskite Band Gaps}
\label{sec:org30e8726}
...
expected to aid in \hyperref[sec:orgda576cc]{inverse design} and in \hyperref[sec:org08692e3]{Feature Engineering}.
...
\citet{yang-2022-high-throug} and in \hyperref[sec:orgea366ee]{DFT Details}.
...
\hyperref[sec:orgc5fbb38]{Methods}.
...
organic-inorganic samples. See figure \ref{fig:lot_mix_org}. See \hyperref[sec:orgc5fbb38]{Methods}
...
perovskite property prediction. See \hyperref[sec:orgfdcdd75]{Results and Discussion}.
...
adapter\footnote{\url{https://github.com/PanayotisManganaris/yogi}\label{org93df589}}.
...
simple entropy minimization algorithm\textsuperscript{\ref{org93df589}}.
...
\section*{Methods}
\label{sec:orgc5fbb38}
\subsection*{DFT Details}
\label{sec:orgea366ee}
...
constituents, we provide a Python tool\footnote{\url{https://github.com/PanayotisManganaris/cmcl}\label{org3f820af}} which robustly coverts
