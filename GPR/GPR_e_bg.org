#+TITLE: Optimized GPR Band Gap Models based on SIS Features
...
#+begin_src jupyter-python
  ...
  import pysisso.sklearn #SISTransformer
#+end_src
...
#+begin_src jupyter-python
  cpipe = joblib.load("./Models/gpr_e_bg.joblib")
#+end_src
...
** Import, initialize, and insert SISTransformer
#+begin_src jupyter-python
  #making feature names compatible with SISSO run
  cpipe[:-1].fit(X_tr)
  tnames = pd.Series(
      cpipe[:-1].get_feature_names_out()
  ).str.replace(" ", "").str.replace("'","").str[4:].str.replace(
      "LoT", "" #remove spaces, useless characters
  ).str[2:].apply(str).str.replace(",",";").str.replace(
      r'\(', "", regex=True #remove parenthesis to avoid Keyerrors on predict
  ).str.replace(r'\)', "", regex=True).str.replace(
      "/", "per" #remove python math operations (also no colons)
  ).str.replace("-", "")
#+end_src
...
#+begin_src jupyter-python
  sissopipe = joblib.load("./Models/sisso_bg.joblib")
#+end_src
...
#+begin_src jupyter-python
  SIS = pysisso.sklearn.SISTransformer(
      sis_out = sissopipe[-1].sis_out,
      columns = tnames.to_list()
  )
#+end_src
...
#+begin_src jupyter-python
  with open('./Models/GPR_e.html', 'w') as f:  
...
#+begin_src jupyter-python :file ../LearningCurves/gpr_e_bg.png
...
#+begin_src jupyter-python
  p.write_html('./LearningCurves/gpr_e_bg.html', include_plotlyjs='../plotly.min.js')
#+end_src
...
**** DONE 2.1 Mix meta estimator
:STATUSLOG:
- State "DONE"       from "TODO"       [2023-01-04 Wed 10:12]
:END:
...
|------------------------------------------------+---------------------------------------------------+-----------+--------------------------------------------+---------------------------------------------------|
| columntransformer__comp__normalizer__norm      | [l1, l2, max]                                     | 1.076819  | [6.77, 15.73, 8.04]                        | [l2]                                              |
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) + 1**2, RBF(length_scale=... | 1.672480  | [2.18, 13.83, 0.94, 1.76, 9.57, 0.0, 2.26] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05, 0.1, 0.15]                                 | 0.838570  | [24.9, 4.29, 1.34]                         | [0.05]                                            |
...
|                                                | space_0                                           | entropy_0 | scores_0                                   | next_0                                            |
|------------------------------------------------+---------------------------------------------------+-----------+--------------------------------------------+---------------------------------------------------|
| columntransformer__comp__normalizer__norm      | [l1, l2, max]                                     | 1.076819  | [8.55, 16.91, 8.79]                        | [l2]                                              |
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) + 1**2, RBF(length_scale=... | 1.672480  | [2.44, 15.93, 1.02, 1.94, 10.4, 0.0, 2.53] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05, 0.1, 0.15]                                 | 0.838570  | [28.14, 4.7, 1.41]                         | [0.05]                                            |
| gaussianprocessregressor__n_restarts_optimizer | [0]                                               | -0.000000 | NaN                                        | [0]                                               |
| gaussianprocessregressor__normalize_y          | [False]                                           | -0.000000 | NaN                                        | [False]                                           |
| gaussianprocessregressor__optimizer            | [fmin_l_bfgs_b]                                   | -0.000000 | NaN                                        | [fmin_l_bfgs_b]                                   |
| gaussianprocessregressor__random_state         | [None]                                            | -0.000000 | NaN                                        | [None]                                            |
...
**** DONE 2.2 LoT meta estimator
:STATUSLOG:
- State "DONE"       from "TODO"       [2023-01-04 Wed 10:20]
:END:
#+begin_src jupyter-python
  cgs = gsCV(estimator=cpipe,
              param_grid=grid,
...
|                                                | space_0                                           | entropy_0 | scores_0                                    | next_0                                            |
|------------------------------------------------+---------------------------------------------------+-----------+---------------------------------------------+---------------------------------------------------|
| columntransformer__comp__normalizer__norm      | [l1, l2, max]                                     | 1.087566  | [8.03, 17.15, 9.06]                         | [l2]                                              |
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) + 1**2, RBF(length_scale=... | 1.672480  | [2.55, 14.67, 1.63, 2.54, 11.02, 0.0, 1.83] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05, 0.1, 0.15]                                 | 0.838570  | [27.99, 4.88, 1.36]                         | [0.05]                                            |
| gaussianprocessregressor__n_restarts_optimizer | [0]                                               | -0.000000 | NaN                                         | [0]                                               |
| gaussianprocessregressor__normalize_y          | [False]                                           | -0.000000 | NaN                                         | [False]                                           |
| gaussianprocessregressor__optimizer            | [fmin_l_bfgs_b]                                   | -0.000000 | NaN                                         | [fmin_l_bfgs_b]                                   |
| gaussianprocessregressor__random_state         | [None]                                            | -0.000000 | NaN                                         | [None]                                            |
...
|                                                | space_0                                           | entropy_0 | scores_0                                   | next_0                                            |
|------------------------------------------------+---------------------------------------------------+-----------+--------------------------------------------+---------------------------------------------------|
| columntransformer__comp__normalizer__norm      | [l1, l2, max]                                     | 1.087566  | [8.47, 17.88, 11.54]                       | [l2]                                              |
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) + 1**2, RBF(length_scale=... | 1.672480  | [3.31, 15.57, 1.82, 3.01, 12.3, 0.0, 1.88] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05, 0.1, 0.15]                                 | 0.838570  | [30.93, 5.49, 1.47]                        | [0.05]                                            |
| gaussianprocessregressor__n_restarts_optimizer | [0]                                               | -0.000000 | NaN                                        | [0]                                               |
| gaussianprocessregressor__normalize_y          | [False]                                           | -0.000000 | NaN                                        | [False]                                           |
| gaussianprocessregressor__optimizer            | [fmin_l_bfgs_b]                                   | -0.000000 | NaN                                        | [fmin_l_bfgs_b]                                   |
| gaussianprocessregressor__random_state         | [None]                                            | -0.000000 | NaN                                        | [None]                                            |
...
**** DONE 2.2 LoT meta estimator
:STATUSLOG:
- State "DONE"       from              [2023-01-04 Wed 10:23]
:END:
#+begin_src jupyter-python
  cgs = gsCV(estimator=cpipe,
              param_grid=grid,
...
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... | 0.693147  | [7.5, 7.0] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05]                                            | -0.000000 | NaN        | [0.05]                                            |
| gaussianprocessregressor__n_restarts_optimizer | [0]                                               | -0.000000 | NaN        | [0]                                               |
| gaussianprocessregressor__normalize_y          | [False]                                           | -0.000000 | NaN        | [False]                                           |
| gaussianprocessregressor__optimizer            | [fmin_l_bfgs_b]                                   | -0.000000 | NaN        | [fmin_l_bfgs_b]                                   |
| gaussianprocessregressor__random_state         | [None]                                            | -0.000000 | NaN        | [None]                                            |
...
|------------------------------------------------+---------------------------------------------------+-----------+------------+---------------------------------------------------|
| columntransformer__comp__normalizer__norm      | [l2]                                              | -0.000000 | NaN        | [l2]                                              |
| gaussianprocessregressor__kernel               | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... | 0.693147  | [8.0, 8.0] | [RBF(length_scale=1) * DotProduct(sigma_0=1) +... |
| gaussianprocessregressor__alpha                | [0.05]                                            | -0.000000 | NaN        | [0.05]                                            |
| gaussianprocessregressor__n_restarts_optimizer | [0]                                               | -0.000000 | NaN        | [0]                                               |
| gaussianprocessregressor__normalize_y          | [False]                                           | -0.000000 | NaN        | [False]                                           |
| gaussianprocessregressor__optimizer            | [fmin_l_bfgs_b]                                   | -0.000000 | NaN        | [fmin_l_bfgs_b]                                   |
...
#+begin_src jupyter-python
  grid =   [
      {'columntransformer__comp__normalizer__norm': ['l2'],
       'gaussianprocessregressor__kernel': [ker_smooth_lin],
       'gaussianprocessregressor__alpha': [0.05],
       'gaussianprocessregressor__n_restarts_optimizer': [0],
       'gaussianprocessregressor__normalize_y': [False],
       'gaussianprocessregressor__optimizer': ['fmin_l_bfgs_b'],
...
#+begin_src jupyter-python :file ../ValidationCurves/gpr_e_bg_alpha.svg
  # mask = lc.score.str.contains('rmse|r2')
  # lc = lc[mask]
...
#+begin_example
  Pipeline(steps=[('columntransformer',
         ...
         '('B', 'Pb')', '('B...
                                           'A;IonE_kJpermol',
                                           'A;Heat_of_fusion_kJpermol',
                                           'A;Heat_of_vap_kJpermol', 'A;En',
                                           'A;at_num', 'A;period', 'B;ion_rad_Å',
                                           'B;Boiling_Point_K',
                                           'B;Melting_Point_K', 'B;dens_gpercc', ...],
                                  sis_out=<pysisso.outputs.FeatureSpace object at 0x7fba1a8f63b0>)),
                  ('gaussianprocessregressor',
                   GaussianProcessRegressor(alpha=0.05,
                                            kernel=RBF(length_scale=1) * DotProduct(sigma_0=1) + 1**2))])
#+end_example
:end:

*** evaluate
#+begin_src jupyter-python :file ../ParityPlots/gpr_e_bg.svg
...
:results:
#+attr_org: :width 700
[[file:../ParityPlots/gpr_e_bg.svg]]
:end:
  
#+begin_src jupyter-python 
  p.write_html('./ParityPlots/gpr_e_bg.html', include_plotlyjs='../plotly.min.js')
#+end_src
...
| rmse_PBE          | -0.202831 |
| rmse_HSE          | -0.382996 |
| rmse_HSE(SOC)     | -0.331677 |
| rmse_HSE-PBE(SOC) | -0.247296 |
:end:

#+begin_src jupyter-python
  pd.concat([data, Y[['Formula', 'LoT', 'mix', 'org']]], axis=1).to_csv('~/data/perovskites/gpr_sis_pred.csv')
#+end_src
...
#+begin_src jupyter-python
  joblib.dump(cpipe, "./Models/gpr_e_bg.joblib")
#+end_src

#+RESULTS:
:results:
| ./Models/gpr_e_bg.joblib |
:end:

* Footnotes
#+NAME: wrap
#+begin_src bash :var p="" :var w="300pt" :var c="" :results output
  echo -ne "$p \n#+attr_latex: :width $w\n#+CAPTION: $c"
#+end_src
